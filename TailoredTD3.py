...
class Tailored_TD3(object):
    def __init__(self, SCHEDULER_OW_DIM, CONTROLLER_OW_DIM, ESTIMATOR_INPUT_DIM, DQN_INPUT_DIM, ACTOR_INPUT_DIM, MAX_ACTION, 
                ...
                GAMMA, TAU, TARGET_ACTOR_NOISE_STD, TARGET_ACTOR_NOISE_CLIP, ACTOR_UPDATE_DELAY, TRANSMISSION_ACTION_LIST, 
                 SORT_FREQ, TIMESTEPS_BEFORE_TRAIN, PRE_TRAINING_TIMESTEPS):
