...
# Initialize policy
policy = Tailored_TD3(SCHEDULER_OW_DIM, CONTROLLER_OW_DIM, ESTIMATOR_INPUT_DIM, DQN_INPUT_DIM, ACTOR_INPUT_DIM, MAX_ACTION, 
...
eval_policy(policy, ENV_NAME, SEED, 0, EVAL_EPISODES, SENSOR_NOISE_STD, COMM_COST, 
...
for t in range(int(MAX_TIMESTEPS)):
    ...
    if done: 
        ...
        SCHEDULER_OW.__init__(LEN, DQN_INPUT_DIM, SCHEDULE_ACTION_DIM)
        CONTROLLER_OW.__init__(LEN, ACTOR_INPUT_DIM, CONTROL_ACTION_DIM)
    ...
    if (t + 1) % EVAL_FREQ == 0:
        eval_policy(policy, ENV_NAME, SEED, t + 1, EVAL_EPISODES, SENSOR_NOISE_STD, COMM_COST, 
                    PRE_TRAINING_TIMESTEPS, LEN, DQN_INPUT_DIM, ACTOR_INPUT_DIM, SCHEDULE_ACTION_DIM, CONTROL_ACTION_DIM)
